	...
	if(isset($_POST['addToCart'])){
		if(isset($_SESSION ["shopping_cart"]))
		{
			...
			else
			{
				...
				echo '<script>window.location="wtops.php"</script>';
			}
		}
		else
		{
		...
		<div class="content">
			<div class="product-model">	 
	 			<div class="container">
                     ...
                     <?php
                        $query = "SELECT * FROM Product WHERE dept='women' and prod_name like '%top' or prod_name like '%set' ORDER BY prod_name ASC";
                        ...
                        if(mysqli_num_rows($result) > 0){
							...
							?>
								...
								<a href="<?php echo $row['sing']; ?>"><div class="product-grid">
									...
									<form method="post" action="wtops.php?action=add&id=<?php echo $row["prod_id"]; ?>">
				...
				<div class="table-responsive">
					...
					<caption style="font-size:50px" >Order Details</caption>
						...
						<tr>
							...
							<td><a href="wtops.php?action=delete&id=<?php echo $values["prod_id"]; ?>"><span class="text-danger">Remove</span></a></td>
						</tr>
						<?php
						...
						<tr>
							...
							<td><a href="wtops.php?action=order&id=<?php echo $values["prod_id"]; ?>"><span class="text-danger">Place Order</span></a></td>
						</tr>
						<?php
						}
						?>
