	...
	if(isset($_POST['addToCart'])){
		if(isset($_SESSION ["shopping_cart"]))
		{
			...
			else
			{
				...
				echo '<script>window.location="single202005.php"</script>';
			}
		}
		else
		{
...
<body>
	...
	<div class="header">
		...
		<div class="header-bottom">
            ...
            <?php
            $query = "SELECT * FROM Product WHERE prod_id = '202005'";
						...
						<div class="single-grids">
							<div class="col-md-4 single-grid">		
								<div class="flexslider">
									<ul class="slides">
									<form method="post" action="single202005.php?action=add&id=<?php echo $row["prod_id"]; ?>">
			...
			<div class="table-responsive">
				...
				<caption style="font-size:50px" >Order Details</caption>
					...
					<tr>
						...
						<td><a href="single202005.php?action=delete&id=<?php echo $values["prod_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
					...
					<tr>
						...
						<td><a href="single202005.php?action=order&id=<?php echo $values["prod_id"]; ?>"><span class="text-danger">Place Order</span></a></td>
					</tr>
					<?php
					}
					?>
